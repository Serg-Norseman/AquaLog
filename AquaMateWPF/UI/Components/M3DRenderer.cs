...
namespace AquaMate.UI.Components
{
    ...
    public class M3DRenderer : SceneRenderer
    {
        ...
        {
            AddTriangle(fCurrentMesh,
                new Point3D(point1.X, point1.Y, point1.Z),
                new Point3D(point2.X, point2.Y, point2.Z),
                new Point3D(point3.X, point3.Y, point3.Z));
        }

        public override void InitScene()
        {
            //fModelGroup.Children.Clear();
        }
        ...
        {
            CreateGeometry(fModelGroup, fCurrentMesh, CreateGlass(), fTransform);
        }

...
namespace AquaMate.UI.Panels
{
    ...
    /// 
    /// </summary>
    public class DataPanel : UserControl, IDataPanel
    {
        ...
        public void AddAction(string actionName, LSID btnText, string imageName, RoutedEventHandler clickHandler)
        {
            fActions.Add(new UserAction(actionName, btnText, imageName, clickHandler));
        }

        public void AddMultiSelector(string actionName, string[] choices, RoutedEventHandler changeHandler)
        {
            fActions.Add(new UserAction(actionName, choices, true, changeHandler));
        }

        public void AddSingleSelector(string actionName, string[] choices, RoutedEventHandler changeHandler)
        {

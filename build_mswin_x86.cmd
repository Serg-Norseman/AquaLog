...
%MSBDIR%\msbuild.exe AquaMate.sln /p:Configuration="Debug" /p:Platform="x86" /t:Rebuild /p:TargetFrameworkVersion=v4.5
...
%NUNIT% AquaMate.Tests\bin\Debug\AquaMate.Tests.dll
pause 
exit /b 0
